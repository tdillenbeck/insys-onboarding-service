...
func NewStringDefaultAsNull(s string) String {
	if s == "" {
		return String{}
	}
...
func NewInt32(v int32) Int32 {
	return Int32{Int32: int32(v), Valid: true}
}
...
func (ns *Int32) UnmarshalJSON(rawData []byte) error {

	if string(rawData) == "null" {
		return nil
	}

	err := json.Unmarshal(rawData, &ns.Int32)
...
func (ns *Int32) Scan(value interface{}) error {
	if value == nil {
		ns.Int32, ns.Valid = 0, false
		return nil
	}
	ns.Valid = true
	return convertAssign(&ns.Int32, value)
}
...
func NewTimeDefaultAsNull(s time.Time) Time {
	if s.IsZero() {
		return Time{}
	}
...
func (ns Date) String() string {
	...
	return ns.Date.Format(`2006-01-02`)
}
