...
func init() {
	proto.RegisterFile("protorepo/services/insys/officeinfo.proto", fileDescriptor_officeinfo_dc7ad1241e9ed59c)
}

var fileDescriptor_officeinfo_dc7ad1241e9ed59c = []byte{
