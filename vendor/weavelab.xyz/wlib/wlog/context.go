...
func DDebugC(c context.Context, msg string, tags ...tag.Tag) {
	defaultLogger.logMessage(c, DDEBUG, msg, tags)
}
...
func (w *WLogger) DDebugC(c context.Context, msg string, tags ...tag.Tag) {
	defaultLogger.logMessage(c, DDEBUG, msg, tags)
}
