...
//go:generate protoc --go_out=import_path=wlogproto:proto -I $GOPATH/src/weavelab.xyz/wlogd/proto/ $GOPATH/src/weavelab.xyz/wlogd/wlogproto/wlog.proto
...
const (
	...
	ERROR  = LogMsgType(2)
	DEBUG  = LogMsgType(3)
	DDEBUG = LogMsgType(4) // TODO: Should DDEBUG level be removed?
)
...
// Deprecated: should use DebugC
func DDebug(msg string, tags ...tag.Tag) {
	defaultLogger.logMessage(nil, DDEBUG, msg, tags)
}
