...
func (h *HandoffSnapshotService) SubmitCSAT(ctx context.Context, onboardersLocationId uuid.UUID, csatRecipientUserId uuid.UUID) (app.HandoffSnapshot, error) {
	return h.SubmitCSATFn(ctx, onboardersLocationId, csatRecipientUserId)
}
